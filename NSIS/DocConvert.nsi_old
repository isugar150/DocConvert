...
Section "MainSection" 
  ...
  File "..\bin\Release\websocket-sharp.dll"
  ...
  CreateShortCut "$SMPROGRAMS\DocConvert\DocConvert Manager.lnk" "$INSTDIR\DocConvert_Manager.exe"
  CreateShortCut "$DESKTOP\DocConvert Manager.lnk" "$INSTDIR\DocConvert_Manager.exe"
  File "..\bin\Release\DocConvert_Core.dll"
  File "..\bin\Release\DocConvert_Manager.exe"
...
Function un.onInit
  MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON2 "$(^Name)�� ��ǻ�Ϳ��� �����Ͻðڽ��ϱ�?" IDYES +2
  Abort
FunctionEnd
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\DocConvert\DocConvert Manager.lnk"
  Delete "$DESKTOP\DocConvert Util.lnk"
  Delete "$DESKTOP\DocConvert Manager.lnk"
